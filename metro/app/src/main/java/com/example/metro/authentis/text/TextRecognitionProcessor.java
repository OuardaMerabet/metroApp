package com.example.metro.authentis.text;
...
import com.example.metro.authentis.other.FrameMetadata;
...
public class TextRecognitionProcessor {
    ...
    public static final String ID_CARD_TD_1_LINE_1_REGEX = "([A|C|I][A-Z0-9<]{1})([A-Z]{3})([A-Z0-9<]{9})([0-9]{1})([A-Z0-9<]{15})";
    ...
    private void filterScannedText(GraphicOverlay graphicOverlay, Text.Element element) {
        ...
        if(docType == DocType.ID_CARD) {
            ...
            if(matcherIDCardTD1Line1.find() && matcherIDCardTD1Line2.find() && matcherIDCardTD1Line3.find()) {
                ...
                String line3 = matcherIDCardTD1Line2.group(0);
